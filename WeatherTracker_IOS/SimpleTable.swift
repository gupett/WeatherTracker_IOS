...
class SimpleTable: UITableViewController {
    ...
    let list = ["temp","molnighet","vind","nederbörd","date",""]
    ...
    func tempSlider(sender:UISlider){
        ...
        switch sender.value {
        case 0:
            tempLabelRef.text = "av"
        case 1:
            tempLabelRef.text = "kallast"
        case 2:
            tempLabelRef.text = "varmast"
        default:
            tempLabelRef.text = nil
        }
    }
    ...
    func windSlider(sender:UISlider){
        ...
        case 2:
            vindLabelRef.text = "medel"
        case 3:
            vindLabelRef.text = "stark"
        default:
            vindLabelRef.text = nil
        }
    }
